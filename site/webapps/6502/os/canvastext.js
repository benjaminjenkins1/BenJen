...
(function (TSOS) {
    var CanvasTextFunctions = /** @class */ (function () {
        ...
        CanvasTextFunctions.clear = function (ctx, font, size, x, y, str) {
            var width = CanvasTextFunctions.measure(font, size, str);
            var height = _DefaultFontSize + _FontHeightMargin + _DrawingContext.fontDescent(font, size);
            ctx.clearRect(x, y + _DrawingContext.fontDescent(font, size), width, -1 * height);
        };
        CanvasTextFunctions.enable = function (ctx) {
            ctx.clearText = function (font, size, x, y, text) { return CanvasTextFunctions.clear(ctx, font, size, x, y, text); };
